...
class Food:
     ...
     foody = round(random.randrange(0, dis_height - 20) / 10.0) * 10.0
     ...
     def restart(self): 
        self.foodx = round(random.randrange(0, dis_width - 20) / 10.0) * 10.0
        self.foody = round(random.randrange(0, dis_height - 20) / 10.0) * 10.0
